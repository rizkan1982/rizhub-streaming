  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative group p-4 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-purple-500/50 rounded-2xl transition-all duration-300"
      ...
      {isOpen && (
        <>
          ...
          {/* Menu Panel */}
          <div className="absolute right-0 mt-4 w-96 max-h-[80vh] overflow-y-auto bg-[#0a0a0f] border border-white/10 rounded-3xl shadow-2xl z-50 animate-fadeIn">
            {/* Header */}
            <div className="sticky top-0 bg-gradient-to-r from-purple-600/20 via-pink-600/20 to-red-600/20 backdrop-blur-xl border-b border-white/10 p-6">
              ...
              {hasActiveFilters && (
                <button
                  ...
                  className="text-sm text-red-400 hover:text-red-300 font-semibold transition-colors flex items-center gap-1"
                >
              ...
              <div className="grid grid-cols-1 gap-2">
                {durations.map((duration) => (
                  <button
                    ...
                    className={`
                      px-4 py-3 rounded-xl font-semibold text-sm transition-all duration-300 text-left
